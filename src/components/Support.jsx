...
const activityData = [
  {
    ...
    description:
      "Hands-on sessions designed to enhance your practical skills, culminating in valuable certification opportunities.",
    images: [
      {
        id: "workshop1",
  ...
  },
  {
    ...
    description:
      "Connecting talented individuals with leading industry opportunities and diverse career paths through dedicated placement drives.",
    images: [
      {
        id: "placement1",
  ...
  },
  {
    ...
    description:
      "Master financial accounting with Tally ERP training, culminating in certification and supported by expert-led 'Train the Trainer' programs for exceptional teaching.",
    images: [
      {
        id: "tally1",
  ...
  },
  {
    ...
    description:
      "Receive personalized guidance from industry experts for career advancement and securing top job opportunities.",
    images: [
      {
        id: "counselling1",
  ...
  },
  {
    ...
    description:
      "Achieve industry recognition and validate your skills with our specialized certification courses and practical workshops.",
    images: [
      {
        id: "certification1",
  ...
  },
  {
    ...
    description:
      "Explore diverse academic environments through our insightful campus visits and gain practical insights with our industrial visits.",
    images: [
      {
  ...
  return (
    <div className="support_page">
      ...
      <section className="support_section">
        <h2
          className="support_section_title"
          data-aos="fade-up"
          style={{ color: "#8c5278" }}
        >
        ...
        {activityData.map((categoryGroup, index) => (
          <div key={index} className="support_category_group">
            <h3
              className="support_category_title"
              data-aos="fade-right"
              style={{ color: "#8c5278" }}
            >
            ...
            <p
              className="support_category_description text-dark"
              data-aos="fade-left"
            >
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.target.src =
                        "https://placehold.co/600x400/4A6572/ECF0F1?text=Image+Error";
                    }}
                  />
      ...
      >
        ...
        <div className="support_cta_content" data-aos="zoom-in">
          ...
          <p>
            From skill-building workshops to vibrant campus events—our community
            shapes futures.
          </p>
          <a
          ...
          >
            ...
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src =
                  "https://placehold.co/800x600/4A6572/ECF0F1?text=Image+Error";
              }}
            />
            <p className="support_modal_caption">{selectedImage.alt}</p>
            <p className="support_modal_note">
